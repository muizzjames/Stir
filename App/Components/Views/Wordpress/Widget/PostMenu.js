...
export default class PostMenu extends Component {
    ...
    render() {
        ...
        if (this.state.categories === null) {
            return <Toolbar name="BeoNews" action={Actions.news} newsLayoutButton={true} searchButton={true}/>
        }

        return <Animated.View style={[css.toolbarView, {transform: [{translateY: this.state._animatedMenu}]}]}>
            <Toolbar name="BeoNews"  action={Actions.news}  newsLayoutButton={true} searchButton={true}/>
