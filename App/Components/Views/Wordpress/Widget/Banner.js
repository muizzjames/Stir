...
import {Text, TouchableOpacity, View, Image, ListView, StatusBar} from "react-native";
...
export default class Banner extends Component {
    ...
    render() {
        ...
        return <View style={{height: 220}}>
            <Swiper
                dot={<View style={{backgroundColor:'rgba(0,0,0,.1)', width: 8, height: 8, borderRadius: 4, marginLeft: 4, marginRight: 4}} />}
                activeDot={<View style={{backgroundColor: 'rgba(0,0,0,.4)', width: 8, height: 8, borderRadius: 4, marginLeft: 4, marginRight: 4}} />}
