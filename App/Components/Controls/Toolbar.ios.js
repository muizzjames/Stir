...
export default class Toolbar extends Component {
    ...
    render() {
        ...
        const homeButton = function () {
            ...
            return (
                <View style={{flexDirection:'row',alignItems:'center',height:0,opacity:0}}>
        ...
        return (
            <View style={css.toolbarMenu}>
                ...
                <View style={css.toolbarTitleView}>
                    <Image resizeMode='contain' style={{width:105,height:20}} source={{ uri: 'http://stirapp.co/img/stir-logo.png'}} />
                </View>
